...
public final class Transformers {
     ...
     */
    // Applicare la funzione a ogni elemento separatamente, uno alla volta, 
    // e poi costruire una nuova lista con tutti i risultati.
    ...
    public static <I> List<I> select(final Iterable<I> base, final Function<I, Boolean> test) {
        Objects.requireNonNull(base, "The base iterable cannot be null");
        Objects.requireNonNull(test, "The test function cannot be null");
